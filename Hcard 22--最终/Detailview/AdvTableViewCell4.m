...
@implementation AdvTableViewCell4
...
-(void)creatUI{
    ...
    NSArray *arr4 = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-85-[_imgBtn7]-5-[_imgBtn8(==_imgBtn7)]-5-[_imgBtn9(==_imgBtn7)]-10-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_imgBtn7,_imgBtn8,_imgBtn9)];
    NSArray *arr5 = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-135-[_imgBtn1]-5-[_imgBtn4(==_imgBtn1)]-5-[_imgBtn7(==_imgBtn1)]-5-[_DZ(==40)]-5-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_imgBtn1,_imgBtn4,_imgBtn7,_DZ)];
    NSArray *arr6 = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-135-[_imgBtn2]-5-[_imgBtn5(==_imgBtn2)]-5-[_imgBtn8(==_imgBtn2)]-50-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_imgBtn2,_imgBtn5,_imgBtn8)];
    NSArray *arr7 = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-135-[_imgBtn3]-5-[_imgBtn6(==_imgBtn3)]-5-[_imgBtn9(==_imgBtn3)]-5-[_PL(==40)]-5-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_imgBtn3,_imgBtn6,_imgBtn9,_PL)];
    ...
    [self.contentView addConstraints:arr7];
