...
@implementation AdvTableViewCell2
...
-(void)creatUI{
    ...
    NSArray *arr3 = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-135-[_imgBtn1]-5-[_DZ(==40)]-5-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_imgBtn1,_DZ)];
    NSArray *arr4 = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-135-[_imgBtn2]-50-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_imgBtn2)];
    NSArray *arr5 = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-135-[_imgBtn3]-5-[_PL(==40)]-5-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_imgBtn3,_PL)];
